...
module.exports = {
	...
	rules: {
		...
		'class-methods-use-this': ['error', { exceptMethods: [...litLifecycle], enforceForClassFields: false }],
	...
	overrides: [
		...
		},
		{
			...
			rules: {
				// https://github.com/typescript-eslint/typescript-eslint/tree/v5.28.0/packages/eslint-plugin#extension-rules
				...
				// https://github.com/typescript-eslint/typescript-eslint/tree/v5.28.0/packages/eslint-plugin#supported-rules
				...
				'@typescript-eslint/explicit-module-boundary-types': ['error', { allowedNames: [...litLifecycle] }],
		...
		{
			files: ['apps/database/imports/**/*.ts'],
			rules: {
				'no-await-in-loop': 0,
			},
		},
